...
% ---
\titulo{Detecção e Classificação Automática de Osteoartrite de Joelho em Radiografias Utilizando Redes Neurais Convolucionais}
\autor{Guilhere de Sousa Santos}
