...
Visando garantir a total transparência e reprodutibilidade da pesquisa, o código-fonte desenvolvido para o pré-processamento, treinamento e avaliação dos modelos, juntamente com os arquivos de resultados em formato JSON citados ao longo deste trabalho, foram disponibilizados em um repositório público no GitHub \cite{github-repo}.
