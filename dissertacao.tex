...
\bibliographystyle{abntex2-alf} % Para citações no estilo autor-data
% ---------------------
...
\begin{siglas}
	...
	\item[CORN] Conditional Ordinal Regression for Neural Networks
	\item[GAP] Global Average Pooling
	\item[GBD] Global Burden of Disease
